...
[center][img]http://www.curseforge.com/media/images/60/958/your_home.png[/img][/center]
...
Currently, I'm not intending to set specific ‘challenges’ for Chunk players, à la Skyblock's. More than anything else, the primary goal of “Oh, chunk.” is to [i]escape[/i] the Chunk into the Overworld.
...
[*]In a similar vein, no mods. Particularly, no SmartMoving, or anything that allows you to fit through 1×1 spaces; but nothing else is considered kosher, either. Play Chunk completely vanilla.[/list]
[hr]
...
Also, it's reasonable to [url="http://gaming.stackexchange.com/questions/44176/how-to-disable-hardcore-in-minecraft"]disable Hardcore after you escape[/url], if you wish to continue playing your world, but aren't the type to enjoy that sort of pressure.[/left]
